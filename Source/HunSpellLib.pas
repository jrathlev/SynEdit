...
type
 ...
 var
  ...
  HunspellRemove: function(Handle: Pointer; const Word: PWideChar): Integer; cdecl;
...
begin
  ...
  if HunspellDll = 0 then begin
    ...
    if HunspellDll <> 0 then begin
      ...
      @HunspellRemove := GetProcAddress(HunspellDll, 'HunspellRemove');
      if not Assigned(HunspellRemove) then Exit;
